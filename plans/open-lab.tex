...
\fancyfoot[R]{\thepage}
\fancyfoot[C]{}
\fancyfoot[L]{\textcolor{gray}{\small Draft --- \today}}
...
\begin{versionhistory}
    \vhEntry{v0.1}{31/01/2026}{---}{Initial working draft}
    \vhEntry{v0.2}{31/01/2026}{---}{Added Related Work, Limitations, Conclusion; trimmed recognition section; addressed reviewer feedback}
\end{versionhistory}
\clearpage
...
regardless of what those organizations say they're doing. The trend is
toward increasing institutional legibility: not that all institutions are
already fully transparent to machines, but that the cost of piercing
opacity is dropping rapidly for anyone motivated to do so.
...
Start by making governance documents public. Then resource tracking. Then
decision rationale. Each step is independently useful and each step makes
the next one easier. The tools described here support any point on that
spectrum.
...
Management becomes engineering. The structure is the product. The first
organization to fully open-source itself will make every opaque
