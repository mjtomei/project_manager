...
the way a user would. If the draft steps describe writing or running
unit tests, asserting strings appear in internal outputs, or inspecting
code rather than running it, reshape them into steps that drive the real
