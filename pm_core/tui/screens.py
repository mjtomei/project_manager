    ...
    def compose(self) -> ComposeResult:
        with VerticalScroll(id="help-container"):
            ...
            if self._in_tasks:
                ...
                yield Label("  [bold]↑↓[/] or [bold]jk[/]  Move between tasks", classes="help-row")
                yield Label("  [bold]J/K[/]  Jump between groups", classes="help-row")
                yield Label("  [bold]Enter[/]  Switch to task window", classes="help-row")
                yield Label("  [bold]Space[/]  Expand/collapse sub-windows", classes="help-row")
                yield Label("  [bold]W[/]  Back to tree view", classes="help-row")
                ...
                yield Label("  [bold]e[/]  Edit PR", classes="help-row")
            ...
            yield Label("  [bold]W[/]  Toggle running tasks", classes="help-row")
            ...
            yield Label("  [bold]G[/]  Merge with companion pane", classes="help-row")
