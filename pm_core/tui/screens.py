...
class HelpScreen(ModalScreen):
    ...
    def compose(self) -> ComposeResult:
        with VerticalScroll(id="help-container"):
            ...
            yield Label("  [bold]z[/]  Modifier prefix (see below)", classes="help-row")
            ...
            yield Label("z Modifier", classes="help-section")
            yield Label("  [bold]z s[/]    Start with companion pane", classes="help-row")
            yield Label("  [bold]zz s[/]   Fresh start", classes="help-row")
            yield Label("  [bold]zzz s[/]  Fresh start + companion", classes="help-row")
            yield Label("  [bold]z g[/]    Merge with companion pane", classes="help-row")
