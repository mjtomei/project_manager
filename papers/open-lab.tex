...
secrecy. More fundamentally, as machine intelligence drives the marginal
cost of necessities downward, the traditional model of extracting value
from labor is weakening. Organizations are shifting from producing goods
and services to producing culture --- community, belonging, supported
livelihood --- a transition already well underway.
...
secrecy further above its competitive value --- the 2025
...
Transparent institutions will also reveal what opaque ones currently hide:
...
Fundamentally, the transition to open organizations is driven by a shift
in what organizations produce. As machine intelligence drives down the
marginal cost of necessities, the extractable value from traditional
production shrinks. The product shifts toward the cultural: community,
identity, belonging, supported livelihood.
...
attacker only needs one of those vulnerabilities to succeed. An attacker 
can take a generated list of exploits, most of them being hallucinations, and
come away with a successfully compromised system. A defender has to 
carefully consider each one and correctly identify and fix the real 
vulnerabilities without adding new ones in order to be protected.
...
Toxic workplace culture (U.S.) & \$223B/5yr & \cite{sull2022b} \\
Hospital claims overturn spending & \$19.7B (2022) & \cite{premier2024} \\
...
%% ============================================================
\section{The Shift towards Cultural Products}
\label{sec:cultural}
%% ============================================================

The previous sections argue that opacity is both externally unsustainable
and internally expensive. But why would organizations move to the open
form described in this paper rather than simply becoming more efficient
opaque organizations? The answer lies in a deeper shift in what
organizations produce.

The traditional business model extracts value from the difference between
what labor produces and what labor costs. A factory hires workers at
\$20/hour whose output sells for \$50/hour; the margin is the business.
This model has driven organizational design for centuries, and it assumes
that human labor is the bottleneck in production. The entire apparatus of
management --- hiring, evaluation, secrecy, hierarchy --- exists to
optimize the extraction of value from that bottleneck.

Machine intelligence and robotics are driving the marginal cost of
necessities --- goods, services, and the labor behind them ---
steadily downward~\cite{rifkin2014}. When an AI system can write code,
generate marketing copy, handle customer service, draft legal documents,
and coordinate logistics, the labor component of production costs drops
precipitously. McKinsey estimates that generative AI could automate
activities accounting for up to 30\% of hours currently worked across
the U.S.\ and European economies by 2030~\cite{mgi2024}. As these
capabilities compound, the extractable margin from human labor shrinks
--- the bottleneck that justified the entire management apparatus is
loosening.

As the cost of producing necessities falls, what retains value? Not the
goods and services themselves, which increasingly become commodity
outputs of cheap machine labor. What retains value is cultural
production: identity,
community, meaning, belonging, and the provision of livelihood
itself. This is the direction
the economy has been moving for centuries. Each major economic transition
has obsoleted the previous value-extraction model: feudal agricultural
production gave way to industrial manufacturing, which gave way to the
service economy, which is now giving way to what Bell~\cite{bell1973}
called the post-industrial society and what we might more precisely call
the cultural economy.

We already live in a partially cultural economy. The creator economy ---
influencers, content creators, streamers, artists monetizing audience
relationships --- was valued at roughly \$250~billion in 2023 and is
projected to approach \$480~billion by
2027~\cite{goldmansachs2023}. These are people whose economic value is
almost entirely cultural: they produce identity, community, and
belonging, not goods. But the cultural economy extends well beyond
creators. Graeber~\cite{graeber2018} documented the prevalence of
jobs --- particularly in large corporations --- where employees
themselves believe their work produces nothing of measurable value,
yet they are well-compensated and their positions persist.

The tech
industry is the most visible example: companies where engineers cycle
through projects that launch, get promoted, and get abandoned, where
impact is difficult to assess because most work does not always clearly
contribute to revenue or user satisfaction. These are not failures of
management. They are
early instances of organizations whose actual product is the provision of
comfortable livelihood to their community of employees --- a cultural
product, not an extractive one.

The most powerful cultural product an organization can offer is
supporting someone's livelihood in totality --- not just a salary, but
membership in a community with purpose, identity, and mutual support.
Currently only companies can do this for their own employees, and it is
expensive: the fully loaded cost of a knowledge worker in a major
metropolitan area easily exceeds \$200{,}000 per year. But as machine
intelligence reduces the cost of providing the material components of
livelihood --- housing, food, healthcare, education --- the cost of
offering this cultural product drops. What is now affordable only for a
company's own employees becomes feasible at broader scale.

This is the mechanism behind the shift to open organizations. When the
product IS the community and its culture, opacity is not merely costly
--- it is antithetical to the product itself. The architecture described in 
this paper --- transparent
governance, visible credit, open decision-making, auditable resource
flows --- is precisely what an organization looks like when its product
is cultural rather than extractive. Transparency is not a governance
improvement bolted onto an existing production model. It is a structural
requirement of the model that is replacing it.
...
on their own terms, or have it imposed from outside. The choice is also
between organizations that understand their product is becoming cultural
--- community, belonging, supported livelihood --- and those that cling
to an extractive production model that machine intelligence is steadily
undermining. We describe an
...
March 2022. \$223B/5yr turnover figure from SHRM, ``The High Cost of a
...
\bibitem{fmi2024}
Market Research Future, ``Open Source Intelligence (OSINT) Market
Size, Share \& Growth Report,'' 2024.
\url{https://www.marketresearchfuture.com/reports/open-source-intelligence-market-4545}

\bibitem{premier2024}
Premier, Inc., ``Trend Alert: Private Payers Retain Profits by
Refusing or Delaying Legitimate Medical Claims,'' 2024.
\url{https://premierinc.com/newsroom/blog/trend-alert-private-payers-retain-profits-by-refusing-or-delaying-legitimate-medical-claims}
...
\bibitem{rifkin2014}
J.~Rifkin, \emph{The Zero Marginal Cost Society: The Internet of Things,
the Collaborative Commons, and the Eclipse of Capitalism}. Palgrave
Macmillan, 2014.

\bibitem{bell1973}
D.~Bell, \emph{The Coming of Post-Industrial Society: A Venture in
Social Forecasting}. Basic Books, 1973.

\bibitem{goldmansachs2023}
E.~Sheridan, ``The Creator Economy Could Approach Half-a-Trillion
Dollars by 2027,'' Goldman Sachs, April 2023.
\url{https://www.goldmansachs.com/insights/articles/the-creator-economy-could-approach-half-a-trillion-dollars-by-2027}

\bibitem{graeber2018}
D.~Graeber, \emph{Bullshit Jobs: A Theory}. Simon \& Schuster, 2018.

\bibitem{mgi2024}
E.~Hazan, A.~Madgavkar, M.~Chui, S.~Smit, D.~Maor, G.~S.~Dandona,
and R.~Huyghues-Despointes, ``A New Future of Work: The Race to Deploy
AI and Raise Skills in Europe and Beyond,'' McKinsey Global Institute,
May 2024.
